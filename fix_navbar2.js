  ...
  return (
    <nav style={{background:"#111",padding:"0 28px",height:"58px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:50}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:"16px"}}>
        ...
        <button onClick={() => signOut({ callbackUrl: "/login" })} style={{background:"transparent",color:"#9ca3af",border:"1px solid #374151",padding:"6px 14px",borderRadius:"5px",fontSize:"12px",cursor:"pointer",fontWeight:"500"}}>Keluar</button>
      </div>
    </nav>
  )
}`;
